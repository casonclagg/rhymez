...
var Rhymez = function () {
    ...
    _createClass(Rhymez, [{
        ...
        key: 'getAlliteration',
        value: function getAlliteration(word) {
            ...
            try {
                for (var _iterator = pronunciations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var activeUtterances = this.activeAlliteration(pronunciation);
                    var stringUtterances = activeUtterances.join(' ');
                    var rhymes = this.alliterations.get(stringUtterances);
                ...
                for (var _iterator3 = this.dict[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    try {
                        for (var _iterator4 = value[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                            ...
                            var activeUtterances = this.activeAlliteration(pronunciation);
                            var stringUtterances = activeUtterances.join(' ');
                            var pool = this.alliterations.get(stringUtterances);
                            if (pool) {
                                pool.push(key);
                            } else {
                                pool = [key];
            ...
            try {
                var _loop = function _loop() {
                    var _step7$value = _slicedToArray(_step7.value, 2),
                        word = _step7$value[0],
                        wordPronounciations = _step7$value[1];
                ...
                for (var _iterator7 = this.dict.entries()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    var _ret = _loop();
        ...
        value: function rhymeCheck(permuted, activePart) {
            ...
            try {
                for (var _iterator8 = permuted[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var x = _step8.value;
