    ...
    _createClass(Rhymez, [{
        ...
        value: function _checkEntry(w, pronounciations, permuted, found, options) {
            ...
            if (matches) {
                ...
                if (pronounciations[0].length < _lodash2.default.sumBy(found, "count")) {
                    ...
                    try {
                        for (var _iterator2 = this.dict.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            var check = this._checkEntry(w2, pronounciations2, permuted.map(function (x) {
                                return x.split(" ").splice(0, permuted[0].length - pronounciations[0].length);
                            }), found, options);
                            if (check && check.length > 0) {
