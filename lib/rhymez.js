...
var Rhymez = function () {
	...
	_createClass(Rhymez, [{
		...
		key: 'endRhyme2',
		value: function endRhyme2(word, count) {
			var _this6 = this;
			...
			try {
				...
				try {
					for (var _iterator4 = pronunciations[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						...
						var activeUtterances = _utteranceUtil2.default.endRhyme2Utterances(pronunciation, count);
		...
		value: function assonance(word) {
			...
			try {
				...
				try {
					for (var _iterator5 = pronunciations[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
						var pronunciation = _step5.value;
				...
				matches = matches.filter(function (x) {
					return !_this7.hasSameUtterances(x, word);
				});
				return matches;
			} catch (ex) {
				return null;
		...
		value: function hasSameUtterances(word1, word2) {
			...
			try {
				for (var _iterator6 = pronunciations1[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
					var pronunciation1 = _step6.value;
					var _iteratorNormalCompletion7 = true;
					var _didIteratorError7 = false;
					var _iteratorError7 = undefined;

					try {
						for (var _iterator7 = pronunciations2[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
							var pronunciation2 = _step7.value;
		...
		value: function loadEndRhymes() {
			...
			try {
				for (var _iterator14 = this.dict[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
					...
					try {
						for (var _iterator15 = value[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
							var pronunciation = _step15.value;
