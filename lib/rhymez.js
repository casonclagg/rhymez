	...
	_createClass(Rhymez, [{
		...
		value: function rhyme(word) {
			...
			matches = matches.filter(function (x) {
				return !_this2.hasSameUtterances(x, word);
			});
			return matches;
		}
	}, {
		...
		value: function hasSameUtterances(word1, word2) {
			...
			try {
				for (var _iterator3 = pronunciations1[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					var pronunciation1 = _step3.value;
					var _iteratorNormalCompletion4 = true;
					var _didIteratorError4 = false;
					var _iteratorError4 = undefined;

					try {
						for (var _iterator4 = pronunciations2[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
							var pronunciation2 = _step4.value;
